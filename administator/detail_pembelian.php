            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="simpan_barang_beli.php" method="post">
                            <div class="form-group">
                                <input type="text" name="pelanggan_id" value="<?= $d['pelanggan_id']; ?>" hidden>
                                <input type="text" name="detail_id" value="<?= $d_detail_penjualan['detail_id']; ?>"
                                    hidden>
                                <select name="produk_id" class="form-control" onchange="this.form.submit()">
                                    ...
                                    <?php
                                            ...
                                            while($d_produk =  mysqli_fetch_array($produk)){
                                                ?>
                                    <option value="<?= $d_produk['produk_id']; ?>"
                                        <?php if($d_produk['produk_id']==$d_detail_penjualan['produk_id']) { echo "selected"; }?>>
                                        <?= $d_produk['nama_produk']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </form>
                        ...
                        <form method="post" action="hitung_subtotal.php">
                            ...
                            <div class="form-group">
                                <input type="number" name="jumlah_produk"
                                    value="<?= $d_detail_penjualan['jumlah_produk']; ?>" class="from_control">
                            </div>
                    </td>
                    ...
                    <td>
                        ...
                        <form method="post" class="mt-1" action="hapus_detail_pembelian.php">
                            <input type="text" name="pelanggan_id" value="<?= $d['pelanggan_id']; ?>" hidden>
                            <input type="text" name="detail_id" value="<?= $d_detail_penjualan['detail_id']; ?> "
                                hidden>
