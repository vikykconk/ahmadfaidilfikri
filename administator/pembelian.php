        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $d['total_harga']; ?></td>
                    <td>
                        <a href="detail_pembelian.php?pelanggan_id=<?= $d['pelanggan_id'] ?>"
                            class="btn btn-info btn-sm">Detail</a>
                        <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal"
                            data-bs-target="#edit-data<?= $d['pelanggan_id'] ?>" <?= $d['pelanggan_id']; ?>>
                            Edit
                        </button>
                        <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                            data-bs-target="#hapus-data<?= $d['pelanggan_id'] ?>" <?= $d['pelanggan_id']; ?>>
                            Hapus
                        </button>
                    </td>
                </tr>
                ...
                <!-- Modal Edit Data -->
                <div class="modal fade" id="edit-data<?= $d['pelanggan_id'] ?>" tabindex="-1"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Data Pembeli</h1>
                            ...
                            <form action="proses_update_pembelian.php" method="post">
                                <div class="modal-body">
                                    <div class="form-group">
                                        <input type="text" name="pelanggan_id" autocomplete="off" class="form-control"
                                            hidden value="<?= $d['pelanggan_id']; ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="nomor_telepon" autocomplete="off" class="form-control"
                ...
                <!-- Modal Hapus Data -->
                <div class="modal fade" id="hapus-data<?= $d['pelanggan_id'] ?>" tabindex="-1"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
...
<div class="modal fade" id="tambah-data" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Tambahkan Pembeli</h1>
            ...
            <form action="proses_pembelian.php" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="pelanggan_id" autocomplete="off" value="<?= date("dmHis") ?>"
